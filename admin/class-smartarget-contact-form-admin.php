 ...
 */
class SmartargetContactForm_Admin {
	...
	public function add_plugin_admin_menu() {
		...
		*/
		add_options_page( 'Smartarget Contact Form Settings', 'Smartarget Contact Form', 'manage_options', $this -> plugin_name, array($this, 'display_plugin_setup_page'));
	}
	...
	public function display_plugin_setup_page() {
		...
		include_once( 'partials/smartarget-contact-form-admin-display.php' );
	}
